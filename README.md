На языке программирования C# разработать приложение Windows, отображающее файлы формата *.po (https://en.wikipedia.org/wiki/Gettext) в виде древовидной структуры. 
